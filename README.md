...
1. Localement, configurez `git` avec votre nom (`user.name`) et votre email (`user.email`) (cf. [Personnalisation de Git](https://git-scm.com/book/fr/v2/Personnalisation-de-Git-Configuration-de-Git));
    ```bash
    # Répondre ici :  : On utilise la commande git config user.name "your username" git // config user.password "your password" pour configurer l'utilisateur localement
    ```
...
Validez les changements (cf. [Enregistrer des modifications dans le dépôt](https://git-scm.com/book/fr/v2/Les-bases-de-Git-Enregistrer-des-modifications-dans-le-d%C3%A9p%C3%B4t));
    ```bash
    # Commandes pour valider les changements : 'git add *' puis 'git commit -m "Changements'
    ```
...
Vérifiez avec le navigateur;
    ```bash
    # Commandes pour publier les modifications : Git add * => Git commit -m "Ajouter toString" => Git push
    ```
...
1. Récupérez localement les modifications effectuées sur la forge.
    ```bash
    # Répondre ici : On utilise la commande : "Git pull"
    ```
